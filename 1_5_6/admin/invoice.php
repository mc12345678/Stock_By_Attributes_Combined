 ...
 * 
 * Stock by Attributes 1.5.4 2018-12-30 mc12345678 @ mc12345678.com
 */
            ...
            <tr class="dataTableRow">
              ...
              <td class="dataTableContent"><?php echo $order->products[$i]['name']; ?>
                  ...
                  <ul>
                      <?php
                      for ($j = 0; $j < $k; $j++) {
                        // BOF "Stock by Attributes" add custom ID to display
                        $customid = null;
                        ...
                        // EOF "Stock by Attributes" add custom ID to display
                        ?>
                      <li>
                        <small><i>
