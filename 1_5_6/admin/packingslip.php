 ...
 * 
 * Stock by Attributes 1.5.4 18-12-23 mc12345678
*/
...
<?php
            ...
            echo (isset($order->products[$i]['customid']['type']) && $order->products[$i]['customid']['type'] == 'multi' && zen_not_null($order->products[$i]['attributes'][$j]['customid']['value']) ? ' (' . $order->products[$i]['attributes'][$j]['customid']['value'] . ') ' : '');
