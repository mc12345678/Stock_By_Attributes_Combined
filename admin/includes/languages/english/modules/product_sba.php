...
// Products and Attribute Copy Options
  ...
  define('TEXT_COPY_SBA_ATTRIBUTES','Copy Stock-By-Attributes to Duplicate with Attributes?');
  define('TEXT_COPY_SBA_ATTRIBUTES_YES','Yes');
  define('TEXT_COPY_SBA_ATTRIBUTES_NO','No');
  
  define('TEXT_SBA_ATTRIBUTE_COPY_SKIPPING','<strong>Skipping New SBA Attribute </strong>');
  define('TEXT_SBA_ATTRIBUTE_COPY_INSERTING','<strong>Inserting New SBA Attribute from </strong>');
  define('TEXT_SBA_ATTRIBUTE_COPY_UPDATING','<strong>Updating from SBA Attribute </strong>');


//TEXT_COPY_SBA_ATTRIBUTES
