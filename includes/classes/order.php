  ...
  function query($order_id) {
    ...
    while (!$orders_products->EOF) {
      ...
      if( STOCK_SBA_DISPLAY_CUSTOMID == 'true') {
         $mod_query = $db->Execute("SELECT customid FROM " . TABLE_ORDERS_PRODUCTS_ATTRIBUTES_STOCK . " WHERE orders_id = " . (int)$order_id . " AND orders_products_id = " . (int)$orders_products->fields['orders_products_id']);
         $this->products[$index]['model'] = $mod_query->fields['customid'];
      }
