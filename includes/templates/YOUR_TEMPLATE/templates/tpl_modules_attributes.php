...
<?php
    if ($is_SBA_product /*$stock->_isSBA*/ && defined('TABLE_PRODUCTS_WITH_ATTRIBUTES_STOCK') && defined('PRODINFO_ATTRIBUTE_DYNAMIC_STATUS') && PRODINFO_ATTRIBUTE_DYNAMIC_STATUS != '0' && (function_exists('zen_class_exists') ? (zen_class_exists('products_with_attributes_class_stock') ? $pwas_class->zen_sba_dd_allowed($products_options_name) : (class_exists('products_with_attributes_class_stock') ? $pwas_class->zen_sba_dd_allowed($products_options_name) : (function_exists('zen_sba_dd_allowed') ? zen_sba_dd_allowed($product_options_name) : true))): (class_exists('products_with_attributes_class_stock') ? $pwas_class->zen_sba_dd_allowed($products_options_name) : (function_exists('zen_sba_dd_allowed') ? zen_sba_dd_allowed($product_options_name) : true)))) {
